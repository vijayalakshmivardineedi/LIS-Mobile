...
const MaidList = () => {
  ...
  const renderItem = ({ item }) => (
    ...
    <TouchableOpacity
      ...
      onPress={() => navigation.navigate("Maid Profile", { id: item._id, userid: item.userid })}
    >
      <Avatar.Image source={{ uri: `https://livinsync.onrender.com${item.pictures}` }} size={50} style={styles.avatarContainer} />
